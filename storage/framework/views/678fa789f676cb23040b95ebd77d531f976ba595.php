		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?php echo e(asset('login/images/logo2.png')); ?>" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action="/postlogin" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input name="email" class="input100" type="text" name="email" value="Admin@gmail.com">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input name="password" class="input100" type="password" name="pass" value="admin123">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
</html><?php /**PATH C:\xampp\htdocs\AdminBarber\resources\views/Auths/login.blade.php ENDPATH**/ ?>